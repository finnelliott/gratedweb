    ...
    <Popover className="relative bg-white dark:bg-gray-900">
      <div className="flex justify-between md:justify-start items-center px-4 py-6 sm:px-6 md:space-x-10 max-w-7xl mx-auto">
        <div>
          ...
          <a className="flex">
            ...
            <svg className="h-4 w-auto sm:h-6 fill-current text-gray-900 dark:text-gray-50" width="139" height="25" viewBox="0 0 139 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="hidden md:flex-1 md:flex md:items-center md:justify-end">
          ...
          <div className="flex-none items-center md:ml-12">
            <Link href={mainNavigation.signUp.linkHref}>
              <a className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-900 hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100">
        ...
        <MoonIcon className="h-6 w-6 hidden md:block text-gray-900 stroke-current dark:text-gray-50" />
        : */}
        <SunIcon className="h-6 w-6 text-gray-900 stroke-current dark:text-gray-50" />
        {/* } */}
        </button>
      ...
      >
        <Popover.Panel focus className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50 dark:divide-gray-700 dark:bg-gray-900">
            <div className="pt-5 pb-6 px-5">
              <div className="flex items-center justify-between">
                <button onClick={() => changeTheme()}>
                    <SunIcon className="h-6 w-6  dark:text-white text-gray-900" />
                </button>
                <div>
                    <span className="sr-only">Grated</span>
                    <svg className="h-4 w-auto sm:h-6 fill-current text-gray-900 dark:text-gray-50" width="139" height="25" viewBox="0 0 139 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="py-6 px-5">
              ...
              <div className="mt-6">
                <Link href={mainNavigation.signUp.linkHref}>
                <a
                  className="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gray-900 hover:bg-gray-800 dark:text-gray-900 dark:bg-white dark:hover:bg-gray-100"
                >
                  {mainNavigation.signUp.linkText}
                </a>
                </Link>
